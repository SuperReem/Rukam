...
const Dashboard_Admin = ()=>{
    ...
    <div>
        <div className="statistics-cards-container">
            <div className="statistics-cards" style={{width: '22%', height: '100%'}}>
            ...
            <div style={{width: '22%', height: '100%'}}>
              <Statistics_Card type={1} title={'عدد مخالفات هذا الأسبوع'} number={132}/>
            </div>
            <div style={{width: '22%', height: '100%'}}>
              <Statistics_Card type={2} title={'عدد بلاغات هذا الأسبوع'} number={182}/>
            </div>
            <div style={{width: '22%', height: '100%'}}>
              <Statistics_Card type={3} title={'عدد الدرونز المفعلة'} number={6}/>
            </div>
        </div>
        <div style={{padding: '1em 0.5em 0.1em 0.5em', display: 'flex', justifyContent: 'space-between'}}>
          {isLoaded? 
            <GoogleMap
          ...
          <div className='reports-statistics'>
            ...
            <div className='d-flex'>
              <div className='ms-4'>
                <div className='d-flex'>
                   <div className='reports-statistics-chart-keys ms-1' id="unsent-key"></div>
               ...
               <ListGroup variant="flush" id='Active-Drones-ListGroup'>
                    <ListGroup.Item>
                        <div className='active-drone-row d-flex justify-content-between p-2'>
                            <div className='d-flex'>
                              <img src={DroneIcon} className='active-drone-icon ms-5'></img>
                              <div>
                            ...
                            <div>
                              <Button variant="secondary" size="sm" id="current-loc-button" className='ms-3'>
