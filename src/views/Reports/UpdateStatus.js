    ...
    <div className="col-sm-6">
      <div className="m-2">
        ...
        <div className="container mt-5 pt-5">
          <div className="row">
            <div className="col-6">
            <Button variant="secondary" size="lg" className="send btn" data-bs-toggle="modal" data-bs-target="#myModal">تحديث حالة البلاغ</Button>
            </div>
            <div className="col-6">
  ...
  <div className="modal-dialog modal-dialog-centered">
    <div className="modal-content">
      ...
      <div className="">
        ...
        <div className="col-2">
        <button data-bs-dismiss="modal" className='closebtn btn rounded'>
      ...
      <Button variant="secondary" size="md" className="updatS btn" onClick={update}>  تحديث الحالة</Button>
